module FhirHl7Converter
  module EncounterAttributeConverter
    ...
    def pv1_to_fhir_text(hl7, terrminology)
      hl7.pv1
      nil
      #Fhir::Narrative
    end

    def pv1_to_fhir_identifiers(hl7, terrminology)
      [DataTypeConverter.cx_to_fhir_identifier(hl7.pv1.visit_number)] if hl7.pv1.visit_number
    end

    def hl7_to_fhir_status(hl7, terrminology)
    ...
    def pv1_to_fhir_participants(hl7, terrminology)
      pv1 = hl7.pv1
    ...
    def pv2_to_fhir_priority(hl7, terrminology)
      hl7.pv2
      nil
      #Fhir::CodeableConcept,PV2-25-visit priority code
    end

    def hl7_to_fhir_hospitalization(hl7, terrminology)
    ...
    def pv1_to_fhir_pre_admission_identifier(hl7, terrminology)
    ...
    def pv1_to_fhir_re_admission(hl7, terrminology)
    ...
    def pv1_to_fhir_location(hl7, terrminology)
...
=end
    ...
    def hl7_to_fhir_service_provider(hl7, terrminology)
